...
class Task extends Equatable {
  ...
  Task copyWith({
    ...
    DateTime? startTime, DateTime? endTime, int? durationMinutes, int? priority,
    String? status, String? categoryId, String? notes, String? repeat,
    DateTime? createdAt, DateTime? completedAt, bool? isAllDay,
    List<String>? tags, double? estimatedValue,
  }) {
    return Task(
      ...
      categoryId: categoryId ?? this.categoryId, notes: notes ?? this.notes,
      repeat: repeat ?? this.repeat, createdAt: createdAt ?? this.createdAt,
      completedAt: completedAt ?? this.completedAt, isAllDay: isAllDay ?? this.isAllDay,
      tags: tags ?? this.tags, estimatedValue: estimatedValue ?? this.estimatedValue,
    );
  }
  ...
  Map<String, dynamic> toMap() => {
    ...
    'durationMinutes': durationMinutes, 'priority': priority,
    'status': status, 'categoryId': categoryId, 'notes': notes, 'repeat': repeat,
    'createdAt': createdAt.millisecondsSinceEpoch,
    'completedAt': completedAt?.millisecondsSinceEpoch,
    'isAllDay': isAllDay ? 1 : 0, 'tags': tags.join(','),
  ...
  factory Task.fromMap(Map<String, dynamic> map) => Task(
    ...
    startTime: map['startTime'] != null
        ? DateTime.fromMillisecondsSinceEpoch(map['startTime']) : null,
    endTime: map['endTime'] != null
        ? DateTime.fromMillisecondsSinceEpoch(map['endTime']) : null,
    durationMinutes: map['durationMinutes'] ?? 30,
    priority: map['priority'] ?? AppConstants.priorityMedium,
    status: map['status'] ?? AppConstants.statusPending,
    categoryId: map['categoryId'], notes: map['notes'],
    repeat: map['repeat'] ?? AppConstants.repeatNone,
    createdAt: DateTime.fromMillisecondsSinceEpoch(map['createdAt']),
    completedAt: map['completedAt'] != null
        ? DateTime.fromMillisecondsSinceEpoch(map['completedAt']) : null,
  ...
  @override
  List<Object?> get props => [id, title, description, date, startTime, endTime,
    durationMinutes, priority, status, categoryId, notes, repeat,
    createdAt, completedAt, isAllDay, tags, estimatedValue];
}
